...
export default function DashboardPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(0,24,57,0.10),transparent_25%),radial-gradient(circle_at_bottom_right,rgba(254,197,3,0.10),transparent_22%)] lg:pl-72">
